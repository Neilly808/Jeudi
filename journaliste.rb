...
puts "le nombre de journaliste présent dans cet array est #{array.count}"
...
puts "#{c} sont les handles qui contiennent des entiers"
...
puts "#{d} sont les noms qui contiennent la lettre \'aude\' "
...
puts "#{e} sont les handles qui se commence par un majuscule. "

f = 0
array.each {|a|
	a.upcase
	if a.match("[:upper:]") != nil 
		f += 1
	end
	}

puts "#{f} sont les handles qui ont des majuscules. "
...
puts "#{g} sont les handles qui présente des \"_\" "
